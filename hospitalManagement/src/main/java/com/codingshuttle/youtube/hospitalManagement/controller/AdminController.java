...
public class AdminController {
    ...
    public ResponseEntity<List<PatientResponseDto>> getAllPatients(
        ...
        // in controller or ser vice layer , we can easily access dat afrom secuitity contexty holder
//        User user= (User) SecurityContextHolder.getContext().getAuthentication().getPrincipal(); // we r getting user here
